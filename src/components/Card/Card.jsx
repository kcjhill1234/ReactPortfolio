...
const CardExampleCard = () => (
  <Card.Group>
    ...
    <Card>
      <Image
        src="/assets/images//code game screen shot.png"
        wrapped
        bordered
        ui={true}
        as="a"
        href="https://kcjhill1234.github.io/CodeQuiz/"
        target="_blank"
      />
      <Card.Content>
    ...
    <Card>
      <Image
        src="/assets/images//music discovery screen shot.png"
        wrapped
        bordered
        ui={true}
        as="a"
        href="https://kcjhill1234.github.io/musicdiscovery/"
        target="_blank"
      />
      <Card.Content>
    ...
    <Card>
      <Image
        src="/assets/images//burgerlogger.png"
        wrapped
        bordered
        ui={true}
        as="a"
        href="https://burger-logger-kenny.herokuapp.com/"
        target="_blank"
      />
      <Card.Content>
    ...
    <Card>
      <Image
        ...
        ui={true}
        as="a"
        href="https://home-kitchen-boss.herokuapp.com/"
        target="_blank"
      />
      <Card.Content>
    ...
    <Card>
      <Image
        src="/assets/images//fit 1.png"
        wrapped
        bordered
        ui={true}
        as="a"
        href="https://workoutrackerkh.herokuapp.com/?id=5f4d2b9bd5dc6600171d1127"
        target="_blank"
      />
      <Card.Content>
    ...
    <Card>
      <Image
        src="/assets/images//BEST3.png"
        wrapped
        bordered
        ui={true}
        as="a"
        href="https://the-best-workout-app-ever.herokuapp.com/"
        target="_blank"
      />
      <Card.Content>
    ...
    <Card>
      <Image
        ...
        ui={true}
        as="a"
        href="https://onlineofflinebudgettrackerkh.herokuapp.com/"
        target="_blank"
      />
      <Card.Content>
